    ...
    return (
        <div className="row">
          <div className="col-sm" >
            <button className="btn btn-dark" onClick={() => getFilmByTage(tages[num1])}>{tages[num1]}</button>
          </div>
          <div className="col-sm" >
            <button className="btn btn-dark" onClick={() => getFilmByTage(tages[num2])}>{tages[num2]}</button>
          </div>
          <div className="col-sm">
            <button className="btn btn-secondary">Теги</button>
          </div>
        </div>
    );
  }
