    ...
    return (
        <div className="row">
          <div className="col-sm" >
            <button className="btn btn-secondary" onClick={() => getFilmByTage(tages[num1])}>{tages[num1]}</button>
          </div>
          <div className="col-sm" >
            <button className="btn btn-secondary" onClick={() => getFilmByTage(tages[num2])}>{tages[num2]}</button>
          </div>
          <div className="col-sm">
            <button className="btn btn-зкшьфкн" onClick={() => getAllTages()}>Теги</button>
          </div>
        </div>
    );
  }
